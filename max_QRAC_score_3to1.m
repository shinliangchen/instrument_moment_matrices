%%% Computing the successful probabilities in the 3 --> 1 QRAC scenario
clear all;
tic;
    ...
    for a = 1:na
        for y = 1:ny
            for b = 1:nb
                ...
                xx = [a,x1x2]; % x_0, x_1, x_2
                SE = SE + (1/24).*p_B_baxy{b,a,x,y}.*kronDel(b,xx(y));
                if b == xx(y)
                    coun = coun + 1;
                end
            end
